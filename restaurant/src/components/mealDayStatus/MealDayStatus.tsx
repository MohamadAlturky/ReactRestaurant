...
interface MealDayStatusProps {
  meals: WeeklyMeals | undefined;
  weekNumber: number;
}
export default function MealDayStatus(props: MealDayStatusProps) {
                      ...
                      {row.meals.find((e) => e.type == "Dinner")?.name ? (
                        <div className="d-flex justify-content-center">
                          <div
                            className={
                              "meal-found-here " +
                              resources.styles.find(
                                (e) =>
                                  e.id ==
                                  row.meals.find((e) => e.type == "Dinner")
                                    ?.reservationStatus
                              )?.style
                            }
                          >
                          ...
                          <div
                            className={
                              ...
                              resources.styles.find(
                                (e) =>
                                  e.id ==
                                  row.meals.find((e) => e.type == "BreakFast")
                                    ?.reservationStatus
                              )?.style
                            }
                          >
